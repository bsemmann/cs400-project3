...
public class GraphTest {
    ...
    /**
     * To check the longest distance
     *
     */
    @Test
    public void testLongestShortPath() {
    assertTrue(graph.getPathCost(1, 5) == 14);
    }
   
    /**
     * To check if the right direction is followed while reaching the last vertex
     * 
     *
     */
    @Test
    ...
    /**
     * To check if the distance between 2 vertices is correct
     *
     */
    @Test
    public void testMethod1() {
    assertTrue(graph.getPathCost(1, 4) == 10);
    }
    /**
     * To check if the right direction is followed while reaching the specified vertex
     *
     */
    @Test
    public void testMethod2() {
     
      assertTrue(graph.shortestPath(1, 4).toString().equals("[1, 7, 0, 2, 4]"));
      }
    /**
     * To check if the distance between 2 vertices is correct
     *
    ...
    assertTrue(graph.getPathCost(8, 9) == 3);
    ...
    assertTrue(graph.shortestPath(7, 3).toString().equals("[7, 6, 3]"));
    }
}
