        ...
        switch (option) {
          ...
          case 1: { // checking if the option is equal to 1
            ...
            if ((city.cityGraph.containsVertex(startPoint)) == false) {
              throw new NoSuchElementException("no initialpoint ");// throws exception if location
                                                                   // not in graph
            ...
            if ((city.cityGraph.containsVertex(destination)) == false) {
              throw new NoSuchElementException("no destination ");// throws exception if destination
                                                                  // not in graph
          ...
          case 2: {
            ...
            exit = input.nextInt();// input an integer
            if (exit != 1 && exit != 0) {
              throw new NoSuchElementException("no number ");// throws exception if user inputs
                                                             // number other than 0,1
            }
            System.out.println("****************************************************");
            if (exit == 0) {
              System.out.println("Have a Great Trip. Bye!!");
          ...
          case 3: {
            ...
            int travelTime = option3(city.getDistance(startPoint, destination), speed);
          ...
          case 4: {
            ...
            int speed = input.nextInt();
            if (speed < 0) {
              throw new NoSuchElementException(" Impossible speed");// throws exception when
                                                                    // negative
                                                                    // number is input
            }
