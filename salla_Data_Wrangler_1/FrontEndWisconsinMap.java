...
/**
 * This class allows for a user to interact with the map of Wisconsin, providing
 * a handful of options for the user to view information about distance between
 * cities, route and travel time.
 * 
...
public class FrontEndWisconsinMap {
	 ...
	 * while reading an String and return that string to the desired variable.
	 *
	...
	public static int promptInt(Scanner sc, int min, int max) {
		...
		do {
			...
			// int token is not within min and max, output error msg and consume line of
			// input
			else {
				System.out.println("Please enter a number between " + min + " and " + max + ".");
	...
	/**
	 * Main method for FrontEndWisconsinMap.java that takes in user input using a
	 * scanner and displays options and requested information to the user.
	 * 
	...
	public static void main(String[] args) {
		...
		while (!startCity.equalsIgnoreCase("exit")) {
			...
			if (choice == 1) {
				System.out.println();
				System.out.println("The distance between " + startCity + " and " + destination + " is "
						+ cbe.getDistance(startCity, destination) + " miles.");
				System.out.println();
				...
				System.out.println("It will take you " + time + " minutes to get from " + startCity + " to "
						+ destination + ", if you were traveling at " + milesPerHour + " miles per hour.");
				System.out.println();
			}
